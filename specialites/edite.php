...
$db=database::connect();
$stm=$db->prepare("SELECT  *FROM specialite WHERE id=? ");
...
//action de mise a jours
  if (!empty($_POST)) {
    ...
    $db=database::connect();
    $stt=$db->prepare("UPDATE specialite set code_sp= ?,libelle_sp= ? WHERE id=?");
...
<center>
 <form class="form-inline" method="POST">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="code" name="code" value="<?php echo $list['code_sp'];?>">
  </div>
  <div class="form-group">
    <label for="libelle">Libelle:</label>
    <input type="text" class="form-control" id="libelle"name="libelle" value="<?php echo $list['libelle_sp'];?>">
  </div>
 <br><br>
